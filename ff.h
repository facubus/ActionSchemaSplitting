...
#define MAX_PREDICATES 300 /*50*/
#define MAX_TYPES 50
#define MAX_ARITY 10 /*5*/
#define MAX_VARS 50
...
/* fuck you
 */
extern int gnum_domain_consts; 
extern int gnum_consts; 
...
extern Bool guniversal_type[MAX_TYPES];/* does type contain all objects? */
...
extern Token ltype_names[MAX_TYPES];
extern int lnum_types;
